  ...
  <div className="mx-auto h-full md:w-10/12 lg:w-6/12">
    <div className="m-auto  py-12 sm:p-20 xl:w-10/12">
      <div className="space-y-4">
        <a href="">
          <img src={Logo} className="w-40 dark:hidden" alt="ayvapp logo" />
          <img src={Logo}className="w-40 hidden dark:block" alt="ayvapp logo" />
        </a>
      </div>
    <div className="mt-12 rounded-3xl border bg-gray-50 dark:border-gray-700 dark:bg-gray-800 -mx-6 sm:-mx-10 p-8 sm:p-10">
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        >
          <div className="flex items-center justify-center space-x-4">
            <img src={Google} className="h-10 w-15" alt="Google" />
            {/* <span className="block w-max text-sm font-semibold tracking-wide text-cyan-700 dark:text-white"> With Google
						</span> */}
          </div>
        </button>
        <button
      ...
      <form action="" className="mt-10 space-y-8 dark:text-white">
        ...
        <div>
          ...
          <a href="/register" type="reset" className="-ml-3 w-max p-3">
      ...
      <div className="border-t pt-12 text-gray-500 dark:border-gray-800">
        <div className="space-x-4 text-center">
          <span>&copy; ayvapp.com</span>
          <a href="/contact" className="text-sm hover:text-sky-900 dark:hover:text-gray-300">Contact</a>
          <a ><a className="text-sm hover:text-sky-900 dark:hover:text-gray-300" href="/privacy">Privacy</a> & <a className="text-sm hover:text-sky-900 dark:hover:text-gray-300" href="/terms">Terms</a> </a>
        </div>
      </div>
    </div>
  </div>
