  ...
  <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
    ...
    >
      ...
      <div className="hidden lg:block lg:relative lg:p-12">
        ...
        <h1 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
          Önemli Oto'ya Hoşgeldiniz.
        </h1>

        <p className="mt-4 leading-relaxed text-white/90">
          Hemen üye olun ve Önemli Oto'nun avantajlı dünyasına katılın.
        </p>
      </div>
    </section>
    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <h1
            className="w-full col-span-6 sm:col-span-3mt-2 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl"
          >
            Önemli Oto Üyelik Formu
          </h1>
          ...
          <div className="col-span-6">
            <label htmlFor="MarketingAccept" className="flex gap-4">
              ...
              <span className="text-sm text-gray-700">
                Önemli Oto'nun yenilikleri hakkında e-posta almak istiyorum.
              </span>
            </label>
          </div>
          ...
          <div className="col-span-6">
            <p className="text-sm text-gray-500">
              Yeni bir hesap oluşturarak Önemli Oto'nun {' '}
              <a href="/terms" className="text-blue-700 underline">
                şartlarını
              </a>
              {'  '} ve {'  '}
              <a href="/privacy" className="text-blue-700 underline">gizlilik koşullarını</a>
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:mt-0">
              Hesabınız var mı? {'  '}
              <a href="/login" className="text-gray-700 underline">Giriş</a>.
            </p>
          </div>
        </form>
      </div>
