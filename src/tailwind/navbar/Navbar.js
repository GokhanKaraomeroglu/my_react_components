...
const aboutUs = [
  {
    name: 'Hakkımızda',
    description: "Toptan ticaretin merkezi ayva.com",
    href: '/about',
    icon: BookmarkSquareIcon,
  },
  {
    name: 'Nasıl Çalışır',
    description: 'Tedarikçi bulmakta tedarikçi olmakta artık çok kolay.',
    href: '/howTo',
    icon: Cog8ToothIcon,
  },
  { name: 'İletişim', 
...
const solutions = [
  {
    name: 'Tedarikçi Ol',
    description: 'Tedarikçi olmanın tam zamanı',
    href: '/supplierPage',
    icon: SparklesIcon,
  },
  {
    name: 'Fiyat Teklif Formu',
    description: 'Ürünlerinizi arayanlara teklifinizi iletin.',
    href: '/quoteForm',
    icon: DocumentTextIcon,
  },
  { name: 'Listem', 
  description: "Ürünlerinizi kimler arıyor gözatın.", 
  href: '/tedarikListe', 
  icon: ListBulletIcon },
  // {
  //   name: 'Boya',
...
const callsToAction = [
  { name: 'Tedarikçi Eğitimi', href: '/tedEducation', icon: PlayIcon },
  { name: 'Tedarikçi Blog', href: '/tedBlog', icon: NewspaperIcon },
]
const callsToAction2 = [
  { name: 'Perakendeci Eğitimi', href: '/parEducation', icon: PlayIcon },
  { name: 'Perakendeci Blog', href: '/parBlog', icon: NewspaperIcon },
]
const resources = [
  {
    name: 'Teadarikçi Ara',
    description: 'En uygun fiyata ihtiyacın olan ürünü bul.',
    href: '/supplierSearch',
    icon: SparklesIcon,
  },
  {
    name: 'Satın Alma Talep Formu',
    description: 'İhtiyacın için talep oluştur.',
    href: '/requestForm',
    icon: DocumentTextIcon,
  },
  { name: 'Listem', 
  description: 'Tedarikçileriniz kimler gözatın.', 
  href: '/perakendeListe', 
  icon: ListBulletIcon 
},
// {
